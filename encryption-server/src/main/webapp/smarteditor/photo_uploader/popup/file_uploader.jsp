...
// String path = "D:\\download\\eclipse-jee-juno-SR2-win32\\workspace\\whollyrental\\src\\main\\webapp\\upload"; // 이미지가 저장될 주소
String path = "/usr/share/tomcat6/whollyrental/whollyrental-image/smartedit";
String filename = "";
