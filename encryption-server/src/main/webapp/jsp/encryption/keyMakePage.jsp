...
function validation() {
	...
	if (document.keyMakeform.encrypt_key.value != document.keyMakeform.key_check.value) {
		document.keyMakeform.encrypt_key.focus();
		alert("키가 일치하지 않습니다.");
		return false;
	} else {
		return true;
...
function register() {
    $.ajax({
        type : "post",
        url : "<c:url value='/keyMake.aj'/>",
        dataType : "html",
        data : $("#keyMakeform").serialize(),
	...
	<div class="row-fluid ">
		...
		<div class="span8">
			<div id="container" class="white"><!-- 배경색 설정 class="brown/white" -->
				<div class="combine">
				<form action="./keyMake.aj" method="post" id="keyMakeform" name="keyMakeform">
					<table summary="신청 상세 내역 영역입니다." class="basic">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="med gray" id="key_check" />&nbsp;<input type="button" id="register" value="키생성" style="vertical-align: 20%"/></td>
							</tr>
						</tbody>
					</table>
				</form>
