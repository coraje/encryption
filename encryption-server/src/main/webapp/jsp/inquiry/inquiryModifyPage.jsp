...
<div id="container" class="brown">
	...
	<div class="combine">
		...
		<tbody>
			<tr>
				<th>제목</th>
				<td><input type="text" class="med gray"    maxlength="80" name="inquiry_subject" value="<%=inquiryVO.getInquiry_subject()%>" /></td>
			</tr>
			<tr>
				<th class="vt">내용</th>
				<td>
					...
					<!-- 에디터 영역 -->
					<TEXTAREA  name="inquiry_content"  maxlength="1000" rows="" cols="" style="width: 100%; height: 200px;" ><%=inquiryVO.getInquiry_content() %></TEXTAREA>
					</div>
				</td>
			</tr>
		...
		<p class="ar mt20">
			<a href="javascript:inquiryRegistration()" class="ml10"><img src="${_ContextPath}/images/sub/btn_write.png"
				alt="글쓰기" /></a><a href="./inquiryList.do" class="ml10"><img
