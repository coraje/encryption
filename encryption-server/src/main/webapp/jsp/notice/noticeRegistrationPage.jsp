...
<!-- container -->
<form action="./noticeRegistration.lo"
...
<div id="container" class="brown">
	...
	<div class="combine">
		...
		<tbody>
			<tr>
				<th>제목</th>
				<td><input type="text" class="med gray"  maxlength="80" name="notice_subject"/></td>
			</tr>
			<tr>
				<th class="vt">내용</th>
				<td>
					...
					<!-- 에디터 영역 -->
					<TEXTAREA  name="notice_content"  maxlength="1000" rows="" cols="" style="width: 100%; height: 200px;"></TEXTAREA>
					</div>
				</td>
			</tr>
