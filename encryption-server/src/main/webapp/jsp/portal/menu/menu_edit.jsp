...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!--
            var saveURL = "<c:url value="/portal/menu/create.do" />";
            var listURL = "<c:url value="/portal/menu/list.do" />";
            var menuListURL = "<c:url value="/portal/menu/list_pop.do" />";
            ...
            $(document).ready(function() {
            	...
            	$("input[name=menuLevel]").filter("input[value='Y']").attr("checked", "checked");
            	
            	$("input[name=popYN]").filter("input[value='N']").attr("checked", "checked");
            	$("input[name=actYN]").filter("input[value='Y']").attr("checked", "checked");
                ...
                $("#searchBtn").click(function() {
                	formSubmit("sendForm", "post", menuListURL, "menuSelectFrame");
                	$("#menuSelectFrame").width(500).height(390);
                    $("#FRAME_AREA").show();
                });
                ...
                $("#saveBtn").click(function(event) {
                	...
                	if($("#sub_level").attr("checked")) {
                    	...
                    	if(parentOid == "0" || parentOid == "") {
                    		alert("<spring:message code="adm.warn.option.selected" arguments="상위 코드" />");
                    		$("#FRAME_AREA").show();
                    		return;
                    	}
                	}
                    ...
                    if(confirm("<spring:message code="adm.message.save.confirm" />")){
	                	$("#BUTTON_AREA").hide();
	                	var sendData = $("#menuForm").serialize();
    ...
    <body>
        <div id="TITLE_AREA">
            ...
            <div id="NAVI_TEXT">
                ...
                &gt; 포탈 관리 &gt; 메뉴 관리
                &gt; <span style="color: #4869AE; font-weight: bold;">메뉴 등록</span>
            </div>
        </div>
            ...
            <table class="info_table_01" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="content_td_01">
                        <input type="text" id="creatorName" name="creatorName" value="관리자" 
                            readonly="readonly" class="input_text_01" style="width: 120px" />
                        <input type="hidden" id="creatorOid" name="creatorOid" value="1" />
                    </td>
                    ...
                    <td class="content_td_01" style="border-right: 0px;">
                        ...
                        <div id="PARENT_MENU" style="display: none;">
                            <input type="text" id="parentMenuName" name="parentMenuName" readonly="readonly" class="input_text_01" style="width: 150px;" />
                            <input type="button" id="searchBtn" name="searchBtn" class="search_btn_s" />
                        </div>
                        <input type="hidden" id="parentOid" name="parentOid" value="0" />
                    </td>
                </tr>
                <tr>
                    <td class="subject_td_01">메뉴 명</td>
                    <td class="content_td_01">
                        <input type="text" id="mnuName" name="mnuName" maxlength="64" class="input_text_01" style="width: 120px;" />
                    </td>
                    <td class="subject_td_01">순서</td>
                    <td class="content_td_01" style="border-right: 0px;">
                        <input type="text" id="mnuOrder" name="mnuOrder" maxlength="3" class="input_text_01" style="width: 25px;" />
                    </td>
                </tr>
                <tr>
                    <td class="subject_td_01">URL</td>
                    <td class="content_td_01" colspan="3" style="border-right: 0px;">
                        <input type="text" id="mnuUrl" name="mnuUrl" class="input_text_01" style="width: 90%;" />
                    </td>
                </tr>
                <tr>
                    <td class="subject_td_02">팝업 여부</td>
                    <td class="content_td_02">
                        <input type="radio" id="popY" name="popYN" value="Y" />
                        <label for="popY">팝업</label>
                        &nbsp;
                        <input type="radio" id="popN" name="popYN" value="N" checked="checked" />
                        <label for="popN">페이지</label>
                    </td>
        ...
        <div id="FRAME_AREA">
            <iframe id="menuSelectFrame" style="width: 0px; height: 0px;" name="menuSelectFrame" frameborder="no" src="htmledit.htm" scrolling="no" />
        </div>
    </body>
</html>